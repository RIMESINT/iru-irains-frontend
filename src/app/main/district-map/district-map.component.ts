...
findMatchingData(id: number): any | null {
  ...
  if (matchedData) {
    // console.log('matchedData inside the if', matchedData)
      return matchedData;
  }
  else {
    return null;
...
//     })
  ...
  getColorForRainfall1(rainfall: any): string {
    // console.log("rainfall", typeof rainfall, rainfall);
    let numericId = rainfall;
    // console.log("numericId", typeof numericId, numericId);
