...
// fetchCenterDetails(regionCode: string, centreType: string = 'MC'): Observable<any> {
//     return this.http.post<any>(`${this.baseUrl}/api/v1/getCenterDetails`, { region_code: regionCode, centre_type: centreType });
//   }
