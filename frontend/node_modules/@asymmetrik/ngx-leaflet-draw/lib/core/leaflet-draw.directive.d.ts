...
export declare class LeafletDrawDirective implements OnInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<LeafletDrawDirective, "[leafletDraw]", never, { "drawOptions": { "alias": "leafletDrawOptions"; "required": false; }; "drawLocal": { "alias": "leafletDrawLocal"; "required": false; }; }, { "drawReady": "leafletDrawReady"; "onDrawCreated": "leafletDrawCreated"; "onDrawEdited": "leafletDrawEdited"; "onDrawDeleted": "leafletDrawDeleted"; "onDrawStart": "leafletDrawStart"; "onDrawStop": "leafletDrawStop"; "onDrawVertex": "leafletDrawVertex"; "onDrawEditStart": "leafletDrawEditStart"; "onDrawEditMove": "leafletDrawEditMove"; "onDrawEditResize": "leafletDrawEditResize"; "onDrawEditVertex": "leafletDrawEditVertex"; "onDrawEditStop": "leafletDrawEditStop"; "onDrawDeleteStart": "leafletDrawDeleteStart"; "onDrawDeleteStop": "leafletDrawDeleteStop"; "onDrawToolbarOpened": "leafletDrawToolbarOpened"; "onDrawToolbarClosed": "leafletDrawToolbarClosed"; "onDrawMarkerContext": "leafletDrawMarkerContext"; }, never, never, false, never>;
}
